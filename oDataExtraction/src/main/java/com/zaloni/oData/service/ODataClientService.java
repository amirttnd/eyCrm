package com.zaloni.oData.service;
...
public class ODataClientService {
    ...
    public void perform(String serviceUrl) throws Exception {
        ...
        ClientEntitySetIterator<ClientEntitySet, ClientEntity> iterator =
                readEntities(edm, serviceUrl, "Categories");
...
//        print("\n----- Read Entry ------------------------------");
//        ClientEntity entry = readEntityWithKey(edm, serviceUrl, "Categories", 1);
...
//        }
    ...
    private ClientEntitySetIterator<ClientEntitySet, ClientEntity> readEntities(Edm edm, URI absoluteUri) {
        ...
        request.addCustomHeader("token", "abc");
